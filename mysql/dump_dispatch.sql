...
CREATE DATABASE IF NOT EXISTS `TaxiDispatch`
...
CREATE TABLE `Trips` (
  ...
  `status` enum('cancelled','ended','ongoing','awaiting_confirmation') NOT NULL,
  `driver_id` int unsigned DEFAULT NULL,
  `vehicle_id` int unsigned DEFAULT NULL,
  `length` double DEFAULT NULL,
  `start_zone_id` int unsigned DEFAULT NULL,
  `end_zone_id` int unsigned DEFAULT NULL,
  PRIMARY KEY (`trip_id`),
  KEY `Trips_Drivers_FK` (`driver_id`),
  KEY `Trips_Vehicles_FK` (`vehicle_id`),
  KEY `Trips_Zones_FK_Start` (`start_zone_id`),
  KEY `Trips_Zones_FK_End` (`end_zone_id`),
  CONSTRAINT `Trips_Drivers_FK` FOREIGN KEY (`driver_id`) REFERENCES `Drivers` (`driver_id`),
  CONSTRAINT `Trips_Vehicles_FK` FOREIGN KEY (`vehicle_id`) REFERENCES `Vehicles` (`vehicle_id`),
  CONSTRAINT `Trips_Zones_FK_End` FOREIGN KEY (`end_zone_id`) REFERENCES `Zones` (`zone_id`),
  CONSTRAINT `Trips_Zones_FK_Start` FOREIGN KEY (`start_zone_id`) REFERENCES `Zones` (`zone_id`)
...
INSERT INTO `Trips` VALUES (1,'2025-09-29 13:26:44',NULL,'ongoing',1,1,0,69,70),(2,NULL,NULL,'awaiting_confirmation',NULL,NULL,0,80,90);
...
CREATE TABLE `Users` (
  ...
  KEY `Users_Drivers_FK` (`driver_id`),
  CONSTRAINT `Users_Drivers_FK` FOREIGN KEY (`driver_id`) REFERENCES `Drivers` (`driver_id`)
...
INSERT INTO `Users` VALUES (1,'admin','admin','admin','$2y$12$NbZIl7C1sbopDUCKmpU8DOKAhrBbOsdK6bVrNLxKbd0YiUdCn/P9S','admin','68ecffa6aebde7.38925175',NULL),(3,'Marc','Dupont','md_driver_01','$2y$12$2q2HaNFOEsfQ0ZUskE/nxeOzW1bOA7lIcnwmGnPSNgUytiOq8nIiG','driver','68ecfd3a6b8574.03906681',1);
...
-- Dump completed on 2025-10-13 15:38:03
